...
def evaluate(epoch,test_data,embedding_matrix, embedding_matrix2,pro_dic,trimatrix):
    decoder = Decoder(embedding_matrix, embedding_matrix2)
    decoder.load_weights('/home/shaoliangliang/code/EERNN/model2/my_model_' + str(epoch + 1))
    print("loadWeight!!!")
    f = open('/home/shaoliangliang/code/EERNN/data/acc.txt', 'w')
    ...
    np.savetxt("/home/shaoliangliang/code/EERNN/result2/" + str(epoch + 1) + "preds.txt", preds)
    np.savetxt("/home/shaoliangliang/code/EERNN/result2/" + str(epoch + 1) + "targets.txt", targets)
    np.savetxt("/home/shaoliangliang/code/EERNN/result2/" + str(epoch + 1) + "binary_preds.txt",binary_preds)
